...
class DynamicRoomRegion:
    def __init__(self, length, width, back_t_length = 0, back_t_width = 0, back_t_offset = 0, front_t_length = 0, front_t_width = 0, front_t_offset = 0):
        ...
        self.hash = hash((length, width, back_t_length, back_t_width, back_t_offset, front_t_length, front_t_width, front_t_offset))
