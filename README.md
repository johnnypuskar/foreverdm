...
Once the containers are running, the app should be accessible on `localhost` (Default port: `5173`). To view the Vue server console logs, run `docker-compose logs -f frontend` in the terminal.
